...
router.get("/wordcloud", async function(req, res ){
  url = 'http://plumber:8000/wordcloud';

  // tbd
  if(req.query.minfreq){
    url = 'http://app:8000/wordcloud?minfreq=' + req.query.minfreq ;
  }

  let tweetRequestUrl = `http://app:3000/tweets?`;
  if(req.query.bbox){
...
router.get("/timeline", async function(req, res ){
  url = 'http://plumber:3000/timeline?';
...
router.get("/quadrat", async function(req, res ){
  var url = 'http://plumber:8000/quadrat';
...
router.get("/lest", async function(req, res ){
  var url = 'http://plumber:8000/lest';
...
router.get("/gest", async function(req, res ){
  var url = 'http://plumber:8000/gest';
...
router.get("/fest", async function(req, res ){
  var url = 'http://plumber:8000/fest';
